...
def iteraDictionary2(key_name, some_list):
    for i in some_list:
        print(i[key_name])

print(iteraDictionary2('first_name', students))
...
def iteraDictionary2(students):
    for i in students:
        print(i['last_name'])

print(iteraDictionary2(students))
